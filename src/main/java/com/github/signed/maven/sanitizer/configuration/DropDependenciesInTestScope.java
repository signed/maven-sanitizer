...
import com.github.signed.maven.sanitizer.pom.dependencies.ManagingDependencyHasScopeTest;
...
public class DropDependenciesInTestScope implements Configuration {
    ...
    public void configure(PomTransformer pomTransformation) {
        ...
        Selector<Dependency> dependenciesInScopeTestWithInheritedVersion = new AndSelector<>(new DependenciesWithInheritedVersion(), new ManagingDependencyHasScopeTest());
