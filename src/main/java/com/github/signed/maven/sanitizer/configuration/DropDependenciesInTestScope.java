...
import com.github.signed.maven.sanitizer.NotSelector;
...
public class DropDependenciesInTestScope implements Configuration {
    ...
    public void configure(PomTransformer pomTransformation) {
        ...
        Selector<Dependency> dependenciesInScopeTestWithInheritedVersion = new AndSelector<>(NotSelector.not(DependenciesInScope.Test()), new DependenciesWithInheritedVersion());
